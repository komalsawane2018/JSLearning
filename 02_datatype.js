var myName = 'Virat Kohli';       // data type "string"
var fatherName = "Yogesh Kohli"

var age = 31;          // Data type number
var weight = 82.5;
...
var num1 = 100; // 200
var num2 = 200; // 100
console.log("Before Swapping Numbers:", num1, num2);

var temp = num1;
num1 = num2; 
num2 = temp;
console.log("After Swapping Numbers:",num1, num2);